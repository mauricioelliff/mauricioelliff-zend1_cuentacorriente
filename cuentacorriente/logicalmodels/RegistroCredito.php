...
abstract class RegistroCredito 
{
    ...
    public function __construct( $datosDelMov, $simular=false )
    {
        ...
        $this->evscxaIdsPaga = (key_exists('seleccion_deuda_item', $datosDelMov ) && count($datosDelMov['seleccion_deuda_item'])>0 )? $this->datosDelMov['seleccion_deuda_item'] : array();
        $this->otrosConceptosPaga = (key_exists('seleccion_otros_conceptos', $datosDelMov ) && count($datosDelMov['seleccion_otros_conceptos'])>0 )? $datosDelMov['seleccion_otros_conceptos'] : array();
